...
from entities.robot.algo.scan_command import ScanCommand
from entities.robot.movement.straight_command import StraightCommand
from entities.map.obstacle import Obstacle
from entities.robot.algo.mod_a_star import ModifiedAStar
    ...
    def plan_path(self):
        ...
        for obstacle in self.simple_hamiltonian:
            ...
            if res is None:
                ...
                print("\tPath found.")
                curr = res
                self.commands.append(ScanCommand(settings.IMAGE_SCAN_TIME, obstacle.index))
