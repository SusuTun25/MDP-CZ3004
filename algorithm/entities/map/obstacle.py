...
from entities.map.position import Position, RobotPosition
...
class Obstacle:
    def __init__(self, x, y, direction, index):
        ...
        self.pos = Position(x * settings.MUTIPLIER, y * settings.MUTIPLIER, direction)

        # Arrow to draw at the target coordinate.
        self.target_image = pygame.transform.scale(pygame.image.load("entities/image/x.png"),
                                                   (50, 50))
